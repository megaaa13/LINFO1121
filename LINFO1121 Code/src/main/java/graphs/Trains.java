 ...
 *   (<a href="https://docs.oracle.com/javase/8/docs/api/java/util/TreeMap.html#subMap-K-boolean-K-boolean-">Here</a>) ?
 */
public class Trains {
    ...
    public static Map<String, Integer> reachableEarliest(HashMap<StationTime, LinkedList<StationTime>> relations, StationTime startPoint) {
        ...
        while (!queue.isEmpty()) {
            ...
            if (solution.containsKey(current.station) && current.time >= solution.get(current.station)) {
